...
export class UserTables1643177106626 implements MigrationInterface {
  name = 'UserTables1643177106626';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "user_link_kinds" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "kind" character varying NOT NULL, CONSTRAINT "PK_6f8a8adbfde7cd3a97baca849db" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "user_links" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "url" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "user_id" uuid, "kind_id" uuid, CONSTRAINT "PK_9eb83d225b238275d61eeedd8b1" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
